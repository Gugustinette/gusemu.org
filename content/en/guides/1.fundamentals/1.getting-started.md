...
This can be useful for a variety of reasons, such as preserving old games that may no longer be available, or allowing you to play games on hardware that you don't have access to.
...
Most importantly, 99% of the time, these developers are doing this work for free, releasing their emulators as [open source](https://en.wikipedia.org/wiki/Open_source) software for anyone to use and contribute to.
