...
[RetroArch](https://www.retroarch.com/) is a special case, as it is a multi-platform emulator that supports a wide range of systems through the [libretro](https://www.libretro.com/) API, which is a standardized interface for emulation [cores](/guides/ressources/glossary#core).
...
With the rise of web technologies, there are now many emulators that can run directly in your web browser, without the need to install any software.

Here are some examples of web-based emulators:

- [libretro Web](https://web.libretro.com/): A web-based interface for running libretro cores directly in your browser.
- [SkyEmu Web](https://web.skyemu.app/): A web version of the SkyEmu emulator, which supports GB, GBC, GBA and DS games.
- [N64 Wasm](https://www.neilb.net/n64wasm/): A web-based emulator for the Nintendo 64, built using WebAssembly.
