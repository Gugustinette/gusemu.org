...
RetroArch itself is not an emulator, but rather a frontend that allows you to run various emulation cores, which are the actual emulators for specific platforms.

This is possible because many emulator developers have created libretro cores for their emulators, allowing them to be used within RetroArch.
