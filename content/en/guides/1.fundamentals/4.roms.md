...
ROMs, or Read-Only Memory, are the files that contain the data from a video game. These are digital copies of the original game cartridges or discs. ROMs are used by emulators to run games on modern hardware.
